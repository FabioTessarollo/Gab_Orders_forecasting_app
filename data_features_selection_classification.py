...
parameters = {
    ...
    'learning_rate': [0.06, 0.07, 0.08],  # Fine-tune learning rate #, 0.08
    'max_depth': [6, 7, 8],  # Control tree depth
    'min_child_weight': [4, 5, 6],  # Additional values to test #, 6
    'subsample': [0.7, 0.8, 0.9],  # More values to test #, 0.9
    'colsample_bytree': [0.7, 0.8],  # More values to test , 0.8
    'n_estimators': [500, 1000],  # Test fewer trees as well
    'scale_pos_weight': [1, 2, 3, 4, 5]  # Important for handling imbalance  1 ,  4, 5
}
